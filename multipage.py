...
def main():
    ...
    def pymc_diff(ctrl_vals, test_vals, draws=1000, tune=500, target_accept=0.9):
        ...
        with pm.Model() as model:
            ...
            mu_t = pm.Normal("mu_t", mu=test.mean(), sigma=test.std() * 10)
            sigma_t = pm.HalfNormal("sigma_t", sigma=test.std() * 10)
